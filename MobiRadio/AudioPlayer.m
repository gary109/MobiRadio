...
extern BOOL isRestartAudio;
extern BOOL isPlayBlock;
extern ViewController *g_viewController;
...
- (id)initAuido:(AudioPacketQueue *)audioQueue withCodecCtx:(AVCodecContext *)pAudioCodecCtx
{
    ...
    [self setVolume:[g_viewController getVolumeLevel]];
    return self;
}
...
- (UInt32)putAVPacketsIntoAudioQueue:(AudioQueueBufferRef)audioQueueBuffer
{
    ...
    if ([audioPacketQueue count]==0) {
        ...
        isPlayBlock = YES;
        //[g_viewController.waitView show:YES];
        //[MBProgressHUD showHUDAddedTo: g_viewController.view animated: YES];
